...
// Per-model timeout. Keeps a single stalled/slow model from eating the entire
// maxDuration budget, so the fallback loop actually gets a chance to try the
// next model instead of the whole request hanging until Vercel force-kills it.
